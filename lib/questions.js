...
const questions = [
    ...
    {
      type: "input",
      message: "Please enter your desired text color (color may be entered as a keyword or hexidecimal",
      name: "textColor",
    },
    {
      type: "list",
    ...
    {
      type: "input",
      message: "Please enter your desired shape color (color may be entered as a keyword or hexidecimal",
      name: "shapeColor",
    },
  ];
